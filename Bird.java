...
class TubeColumn {
    ...
    public void tick() {
        ...
        for (int i = 0; i < tubes.size(); i++) { // Loop OBJECT
            tubes.get(i).tick();
...
class Game extends JPanel implements ActionListener {
    ...
    private void endGame() {
        ...
        this.tubeColumn.setPoints(0); // SET THE CURRENT SCORE IS 0
...
class Window {
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Window window = new Window(WIDTH, HEIGHT, "Soch ke rakhunga ", game);
        });
    }
}
